    ...
    <?php foreach ($data['movies'] as $movie):?>
        <div class="movies-block">
            <div class="row">
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12 movie-placeholder"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 movie-img-block"><img src="<?= $movie->image?>"></div>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-12"><h2 class="text-center movie-title" ><?= $movie->name?></h2></div>
                    </div>
                    <div class="row">
