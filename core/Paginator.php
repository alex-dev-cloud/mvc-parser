...
class Paginator
{
    ...
    public function getHTML(){
        ...
        $first = $cur > 1 ? '<li><a href="'.$url.'1'.'">'.'1'.'</a>' : NULL;
        $prev = $cur > 1 ? '<li><a href="'.$url.($cur - 1).'">&laquo;&laquo;</a>' : NULL;
        ...
        $next = $cur < $tot ? '<li><a href="'.$url.($cur + 1).'">&raquo;&raquo;</a>' : NULL;
        $last = $cur < $tot ? '<li><a href="'.$url.$tot.'">'.$tot.'</a>' : NULL;
